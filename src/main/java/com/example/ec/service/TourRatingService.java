...
public class TourRatingService {
    ...
    public List<TourRating> lookupAll() {
        ...
        tourRatingRepository.findAll().forEach(tourRatings::add);
        return tourRatings;
    }
    /**
    ...
    public void rateMany(int tourId,  int score, Integer[] customers) {
        ...
        var tour = tourRepository.findById(tourId).orElseThrow(() -> new NoSuchElementException("Tour not found: " + tourId));
